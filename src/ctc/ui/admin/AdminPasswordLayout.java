...
public class AdminPasswordLayout{
	...
	public AdminPasswordLayout(Shell shell, MinaClient minaClient,String userName, String password){
	...
	public Composite create(Composite parentComp) {
		...
		createGroup(comp, "管理员信息维护","pos 0.5al 0.2al",null);
