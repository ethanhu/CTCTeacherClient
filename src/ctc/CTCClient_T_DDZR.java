...
public class CTCClient_T_DDZR extends JFrame implements ActionListener {
	...
	public final static Logger LOGGER = LoggerFactory.getLogger("CTCTeacher_DDZR");
	...
	public static void main(String[] args)
	{
		...
		CTCClient_T_DDZR loginAccess = new CTCClient_T_DDZR();
		...
		//	getStationplanList(rMsg);
			...
			*/
			if(rMsg.getUserRole() == Constants.USER_ROLE_TEACHER){//启动教师管理界面
				...
				new CTCTeacherMain(minaClient,userName,passwordString,rMsg.getTeamID(),rMsg.getDistrictName(),roleFlag).start();
			}
			else
